...
export const partTimeEmployeeSchedule: Employees[] =[
    ...
    { name: "JUHEON", availableDay: ["MON", "TUE", "WED", "THU", "FRI", "SAT"], availableTime: ["DAY", "NIGHT"], availablePosition : ["A", "B", "HOST"], maxShifts: 3},
    { name: "SIMON", availableDay: ["SUN", "THU", "FRI", "SAT"], availableTime: ["DAY", "NIGHT"], availablePosition : ["A", "B", "BAR", "HOST"], maxShifts: 2},
    { name: "DAVID", availableDay: ["MON", "WED", "FRI", "SAT"], availableTime: ["DAY", "NIGHT"], availablePosition : ["A", "B", "BAR"], maxShifts: 1},
